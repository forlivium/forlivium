      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mt-16 text-center">
          <div className="inline-block rounded-full bg-forlivium-red/10 px-6 py-3 mb-6">
            <span className="text-forlivium-red font-medium">1000+ Community Members</span>
          </div>
          
          <div className="max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-3 gap-6">
            <div className="text-center">
              <p className="text-4xl font-bold text-forlivium-red">100+</p>
              <p className="text-sm text-gray-600">Discord Members</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-forlivium-red">1000+</p>
              <p className="text-sm text-gray-600">Telegram Members</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-forlivium-red">1k+</p>
